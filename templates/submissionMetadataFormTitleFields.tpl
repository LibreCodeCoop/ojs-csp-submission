...
<div class="pkp_helpers_clear">
	{fbvFormSection for="title" label="plugins.generic.CspSubmission.ShortTitle" description="plugins.generic.CspSubmission.ShortTitle.Description"  inline="true" size=$fbvStyles.size.LARGE required=true}
