...
{fbvFormArea id="submissionStep1"}
	...
	{fbvFormSection for="commentsToEditor" label="submission.submit.coverNote" required=true description="plugins.generic.CspSubmission.commentsToEditor.Description"}
		{fbvElement type="textarea" name="commentsToEditor" id="commentsToEditor" value=$commentsToEditor required=true}
	{/fbvFormSection}
