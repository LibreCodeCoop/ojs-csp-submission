...
<form class="pkp_form" id="editAuthor" method="post" action="{url op="updateAuthor" authorId=$authorId}">
	...
	{include
		file="../plugins/generic/cspSubmission/templates/userDetails.tpl"
	...
	{fbvFormSection title="plugins.generic.CspSubmission.AuthorContribution" required=false}
		{fbvElement type="textarea" name="authorContribution" id="authorContribution" value=$authorContribution required=false}
	{/fbvFormSection}
